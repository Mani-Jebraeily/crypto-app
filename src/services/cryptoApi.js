...
const getChart=(coin,currency)=>`${BASE_URL}/coins/${coin}/market_chart?vs_currency=${currency}&days=7&x_cg_demo_api_key=${API_KEY}`

const getSingleCoin=(id,currency)=>`${BASE_URL}/coins/markets?vs_currency=${currency}&ids=${id}&x_cg_demo_api_key=${API_KEY}`
